...
thirty_team <- b %>%
  ...
  ggplot(aes(x = year, y = pitch_year, fill = year, text = text_label)) +
  geom_col() +
  labs(x = "Season", y = "Pitchers per Year", title = "Number of Pitchers used per Year in 30 Team Era")
```
